![VideoJS](README/VideoJS.png)

#### Video.js is a web video player built from the ground up for an HTML5 world. It supports HTML5 and Flash video, as well as YouTube and Vimeo (through [plugins][plugins]). It supports video playback on desktops and mobile devices.

---

![VideoJS](README/VideoJS.gif)
...
#### If you're ready to dive in, the [Getting Started](https://videojs.com/getting-started) page and [docs](https://docs.videojs.com/) are the best places to go for more information.
